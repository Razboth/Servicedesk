// JavaScript version of ATM claim templates seed
// Use this if TypeScript/tsx is not working on your server
...
async function seedATMClaimTemplates() {
  ...
  try {
    ...
    console.log(`\n✅ Processed ${fieldTemplates.length} field templates`);
...
module.exports = { seedATMClaimTemplates };