...
import { Download, TrendingUp, TrendingDown, Users, Clock, Calendar, Activity, LayoutDashboard, LineChartIcon, PieChartIcon, Table } from 'lucide-react';
...
const tabConfig = [
  ...
  { id: 'analysis', label: 'Analysis', icon: Table },
];
