  ...
  const handleSave = async () => {
    ...
    try {
      const response = await fetch(`/api/branch/atm-claims/${ticketId}/verify`, {
        ...
        body: JSON.stringify({
          ...verification,
          cashOpening: verification.cashOpening ? parseFloat(verification.cashOpening) : null,
          cashDispensed: verification.cashDispensed ? parseFloat(verification.cashDispensed) : null,
          cashRemaining: verification.cashRemaining ? parseFloat(verification.cashRemaining) : null,
          cashVariance: verification.cashVariance ? parseFloat(verification.cashVariance) : null
        })
      });
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <Input
                ...
                readOnly
                className={`${
                  parseFloat(verification.cashVariance) !== 0 
