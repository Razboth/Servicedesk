...
export function Sidebar() {
  ...
  const isActive = (path: string) => {
    ...
    if (path === '/p20t/checklist') {
      return pathname === '/p20t/checklist';
    }
    if (path === '/admin/p20t/assignments') {
      return pathname === '/admin/p20t/assignments';
    }
    if (path === '/admin/p20t/checklist-templates') {
      return pathname === '/admin/p20t/checklist-templates';
    }
  ...
  return (
    <>
      ...
      <nav className="flex-1 p-4 space-y-2 overflow-y-auto">
        ...
        {/* P20T Section - Checklist visible to all, Admin links only for admins */}
        <div className="space-y-1">
          {(!isCollapsed || isMobile) && <div className="text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-wider px-3 py-2">P20T</div>}
          <Link href="/p20t/checklist" className={linkClass('/p20t/checklist')} onClick={handleLinkClick}>
            <svg className={iconClass} fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" />
            </svg>
            {(!isCollapsed || isMobile) && 'P20T Checklist'}
          </Link>
          {(session.user?.role === 'ADMIN' || session.user?.role === 'SUPER_ADMIN') && (
            <>
              <Link href="/admin/p20t/assignments" className={linkClass('/admin/p20t/assignments')} onClick={handleLinkClick}>
                <svg className={iconClass} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                </svg>
                {(!isCollapsed || isMobile) && 'P20T Assignments'}
              </Link>
              <Link href="/admin/p20t/checklist-templates" className={linkClass('/admin/p20t/checklist-templates')} onClick={handleLinkClick}>
                <svg className={iconClass} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" />
                </svg>
