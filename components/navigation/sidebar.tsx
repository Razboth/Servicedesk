      ...
      <nav className="flex-1 p-4 space-y-2 overflow-y-auto">
          ...
          <div className="space-y-1">
            ...
            {(session.user?.supportGroupCode === 'TECH_SUPPORT' || session.user?.role === 'SUPER_ADMIN') && (
              <>
                ...
                <Link href="/admin/os-management" className={linkClass('/admin/os-management')} onClick={handleLinkClick}>
                  <svg className={iconClass} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  {(!isCollapsed || isMobile) && 'OS Management'}
                </Link>
                <Link href="/admin/office-management" className={linkClass('/admin/office-management')} onClick={handleLinkClick}>
                  <svg className={iconClass} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                  </svg>
                  {(!isCollapsed || isMobile) && 'Office Management'}
                </Link>
              </>
            )}
        ...
        {(session.user?.role === 'ADMIN' || session.user?.role === 'SUPER_ADMIN') && (
          <div className="space-y-1">
            ...
            <Link href="/admin/vendors/performance" className={linkClass('/admin/vendors/performance')} onClick={handleLinkClick}>
              <svg className={iconClass} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
              </svg>
              {(!isCollapsed || isMobile) && 'Vendor Performance'}
            </Link>
            <Link href="/admin/pc-assets" className={linkClass('/admin/pc-assets')} onClick={handleLinkClick}>
              <svg className={iconClass} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
