...
export function Sidebar() {
  ...
  const isActive = (path: string) => {
    ...
    if (path === '/technician/server-checklist') {
      return pathname === '/technician/server-checklist';
    }
    if (path === '/technician/checklist-v2') {
      return pathname === '/technician/checklist-v2';
    }
    if (path === '/supervisor/checklist-v2') {
      return pathname === '/supervisor/checklist-v2';
    }
    if (path === '/admin/checklist-assignments') {
      return pathname === '/admin/checklist-assignments';
    }
    if (path === '/admin/checklist-standby') {
      return pathname === '/admin/checklist-standby';
    }
    if (path === '/manager/checklist-templates-v2') {
      return pathname === '/manager/checklist-templates-v2';
    }
    // For exact matching of my-tickets route (to avoid conflict with /tickets)
    if (path === '/tickets/my-tickets') {
      return pathname === '/tickets/my-tickets';
    }
    // For my-assets route
    if (path === '/my-assets') {
      return pathname === '/my-assets' || pathname.startsWith('/my-assets/');
    }
    // For exact matching of /tickets route (to avoid conflict with /tickets/my-tickets)
    if (path === '/tickets') {
    ...
    <>
      ...
      <nav className="flex-1 p-4 space-y-2 overflow-y-auto">
        ...
        <div className="space-y-1">
          ...
          <Link href="/my-assets" className={linkClass('/my-assets')} onClick={handleLinkClick}>
            <svg className={iconClass} fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
            </svg>
            {(!isCollapsed || isMobile) && 'My Assets'}
          </Link>
        </div>
        ...
        {session.user?.role === 'TECHNICIAN' && session.user?.supportGroupCode !== 'CALL_CENTER' && (
          <div className="space-y-1">
            ...
            <Link href="/technician/server-checklist" className={linkClass('/technician/server-checklist')} onClick={handleLinkClick}>
              <svg className={iconClass} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 12h14M5 12a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v4a2 2 0 01-2 2M5 12a2 2 0 00-2 2v4a2 2 0 002 2h14a2 2 0 002-2v-4a2 2 0 00-2-2m-2-4h.01M17 16h.01" />
              </svg>
              {(!isCollapsed || isMobile) && 'Server Checklist'}
            </Link>
            <Link href="/technician/checklist-v2" className={linkClass('/technician/checklist-v2')} onClick={handleLinkClick}>
              <svg className={iconClass} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" />
              </svg>
              {(!isCollapsed || isMobile) && 'Checklist Harian'}
            </Link>
        ...
        {session.user?.role === 'SUPERVISOR' && (
          <div className="space-y-1">
            {(!isCollapsed || isMobile) && <div className="text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-wider px-3 py-2">Supervisor</div>}
            <Link href="/supervisor/checklist-v2" className={linkClass('/supervisor/checklist-v2')} onClick={handleLinkClick}>
              <svg className={iconClass} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" />
              </svg>
              {(!isCollapsed || isMobile) && 'Checklist Dashboard'}
            </Link>
            <Link href="/technician/checklist-v2" className={linkClass('/technician/checklist-v2')} onClick={handleLinkClick}>
              <svg className={iconClass} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" />
          ...
          <div className="space-y-1">
            ...
            {session.user?.role === 'MANAGER_IT' && (
              <>
                ...
                <Link href="/manager/checklist-templates" className={linkClass('/manager/checklist-templates')} onClick={handleLinkClick}>
                  <svg className={iconClass} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" />
                  </svg>
                  {(!isCollapsed || isMobile) && 'Checklist Templates'}
                </Link>
                <Link href="/manager/checklist-templates-v2" className={linkClass('/manager/checklist-templates-v2')} onClick={handleLinkClick}>
                  <svg className={iconClass} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" />
                  </svg>
                  {(!isCollapsed || isMobile) && 'Checklist Templates V2'}
                </Link>
                <Link href="/admin/checklist-assignments" className={linkClass('/admin/checklist-assignments')} onClick={handleLinkClick}>
                  <svg className={iconClass} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                  </svg>
                  {(!isCollapsed || isMobile) && 'Checklist Assignments'}
                </Link>
                <Link href="/supervisor/checklist-v2" className={linkClass('/supervisor/checklist-v2')} onClick={handleLinkClick}>
                  <svg className={iconClass} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" />
                ...
                <Link href="/manager/shift-statistics" className={linkClass('/manager/shift-statistics')} onClick={handleLinkClick}>
                  <svg className={iconClass} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                  </svg>
                  {(!isCollapsed || isMobile) && 'Shift Statistics'}
                </Link>
              </>
            )}
        ...
        {(session.user?.role === 'ADMIN' || session.user?.role === 'SUPER_ADMIN') && (
          <div className="space-y-1">
            {(!isCollapsed || isMobile) && <div className="text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-wider px-3 py-2">Checklist Management</div>}
            <Link href="/admin/checklist-standby" className={linkClass('/admin/checklist-standby')} onClick={handleLinkClick}>
              <svg className={iconClass} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.5-9a2.5 2.5 0 11-5 0 2.5 2.5 0 015 0z" />
              </svg>
              {(!isCollapsed || isMobile) && 'Staff Standby'}
            </Link>
            <Link href="/admin/checklist-assignments" className={linkClass('/admin/checklist-assignments')} onClick={handleLinkClick}>
              <svg className={iconClass} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
              </svg>
              {(!isCollapsed || isMobile) && 'Schedule Assignments'}
            </Link>
            <Link href="/manager/checklist-templates-v2" className={linkClass('/manager/checklist-templates-v2')} onClick={handleLinkClick}>
              <svg className={iconClass} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" />
            ...
            {(!isCollapsed || isMobile) && <div className="text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-wider px-3 py-2 mt-2">Administration</div>}
        ...
        {session.user?.role === 'SECURITY_ANALYST' && (
          <div className="space-y-1">
            {(!isCollapsed || isMobile) && <div className="text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-wider px-3 py-2">Security Operations</div>}
            <Link href="/security/soc-parser" className={linkClass('/security/soc-parser')} onClick={handleLinkClick}>
              <svg className={iconClass} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.031 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
              </svg>
              {(!isCollapsed || isMobile) && 'SOC Parser'}
            </Link>
            <Link href="/security/antivirus-alert" className={linkClass('/security/antivirus-alert')} onClick={handleLinkClick}>
              <svg className={iconClass} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
              </svg>
              {(!isCollapsed || isMobile) && 'Antivirus Alert'}
            </Link>
            <Link href="/security/reports" className={linkClass('/security/reports')} onClick={handleLinkClick}>
              <svg className={iconClass} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
              </svg>
              {(!isCollapsed || isMobile) && 'Security Reports'}
            </Link>
          </div>
        )}
        ...
        {(session.user?.role === 'ADMIN' ||
          ...
          <div className="space-y-1">
            ...
            <Link href="/reports/server-metrics" className={linkClass('/reports/server-metrics')} onClick={handleLinkClick}>
              <svg className={iconClass} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 12h14M5 12a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v4a2 2 0 01-2 2M5 12a2 2 0 00-2 2v4a2 2 0 002 2h14a2 2 0 002-2v-4a2 2 0 00-2-2m-2-4h.01M17 16h.01" />
              </svg>
              {(!isCollapsed || isMobile) && 'Server Metrics'}
            </Link>
          </div>
        )}
      </nav>
