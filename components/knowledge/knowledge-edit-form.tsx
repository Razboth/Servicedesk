...
export default function KnowledgeEditForm({ articleId, initialData }: KnowledgeEditFormProps) {
    ...
    try {
      ...
      if (attachments.length > 0) {
        ...
        try {
          ...
          toast.error('Article updated but some attachments failed to upload')
        } finally {
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          ...
          >
            ...
            {isSubmitting || loading ? 'Updating...' : 'Update Article'}
          </Button>
        </div>
      </div>

      {/* Version History */}
      {showVersionHistory && initialData.versions && initialData.versions.length > 0 && (
        <Card>
          <CardHeader>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                />
                {errors.changeNotes && (
                  <p className="text-sm text-red-500 mt-1">{errors.changeNotes.message}</p>
                )}
                <p className="text-sm text-gray-500 mt-1">
            ...
            <CardContent className="space-y-4">
              ...
              {attachments.length > 0 && (
                <div className="space-y-2">
                  <Label>New Files to Upload ({attachments.length})</Label>
                  <div className="space-y-2">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <Select
                  value={watch('status')}
                  onValueChange={(value: 'DRAFT' | 'UNDER_REVIEW' | 'PUBLISHED' | 'ARCHIVED') => setValue('status', value)}
                >
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
              ...
              <div>
                ...
                />
                <p className="text-sm text-gray-500 mt-1">
                  Article will be archived after this date
                </p>
              </div>
            </CardContent>
          </Card>
